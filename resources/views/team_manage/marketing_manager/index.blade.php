                        ...
                        <table id="marketing_manager_lists" class="table table-bordered text-nowrap mb-0">
                            <thead class="border-top">
                                <tr>
                                    ...
                                    <th class="bg-transparent border-bottom-0">Reference Code</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($marketing_managers as $marketing_manager)
                                    <tr class="border-bottom">
                                        ...
                                        <td>
                                            {{ $marketing_manager->alternate_mobile }}
                                        </td>
                                        <td>
                                        ...
                                        {{-- <td>
                                            {{ $marketing_manager->state_id }}
                                        </td>
                                        <td>
                                            {{ $marketing_manager->country_id }}
                                        </td> --}}
                                        <td>
                                            {{ $marketing_manager->pincode }}
                                        </td>
                                        <td class="">
