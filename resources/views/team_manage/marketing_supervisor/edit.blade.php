    ...
    <div class="row row-sm mt-2">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="Edit_marketingSupervisorForm" class="p-3">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="reference_code" id=""
                                        value="{{ !empty($marketing_supervisor->reference_code) ? $marketing_supervisor->reference_code : '' }}"
                                        readonly>
                                </div><small class="text-danger reference_code"></small>
                            </div>
                            <div class="col-md-4">
                                <input type="hidden" id="marketing_supervisor_id" value="{{ $marketing_supervisor->id }}">
                                <label class="form-label">Name <span class="text-red">*</span></label>
                                <div class="input-group">
                                    <input type="text" class="form-control" name="name" id=""
                                        placeholder="Name"
                                        value="{{ !empty($marketing_supervisor->name) ? $marketing_supervisor->name : '' }}">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="email" id=""
                                        value="{{ !empty($marketing_supervisor->email) ? $marketing_supervisor->email : '' }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="mobile_no" id=""
                                        ...
                                        value="{{ !empty($marketing_supervisor->mobile_no) ? $marketing_supervisor->mobile_no : '' }}">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="alternate_mobile" id=""
                                        ...
                                        value="{{ !empty($marketing_supervisor->alternate_mobile) ? $marketing_supervisor->alternate_mobile : '' }}">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="address" id=""
                                        placeholder="Address"
                                        value="{{ !empty($marketing_supervisor->address) ? $marketing_supervisor->address : '' }}">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <div class="input-group-text">
                                        ...
                                        name="dob"
                                        value="{{ !empty($marketing_supervisor->dob) ? $marketing_supervisor->dob : '' }}">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <select name="gender" class="form-control SlectBox">
                                        ...
                                        <option value="1" {{ $marketing_supervisor->gender == 1 ? 'selected' : '' }}>
                                            Male</option>
                                        <option value="0" {{ $marketing_supervisor->gender == 0 ? 'selected' : '' }}>
                                            Female
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="pincode" id="pincode"
                                        placeholder="Pincode" value="{{ $marketing_supervisor->pincode }}">
                                </div>
                                    ...
                                    <select name="area" id="area" class="form-control SlectBox">
                                        ...
                                        @foreach ($areas as $area)
                                            <option value="{{ $area->id }}"
                                                {{ !empty($area->id == $marketing_supervisor->area) ? 'selected' : '' }}>
                                                {{ $area->area }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <select name="country_id" class="form-control SlectBox">
                                        ...
                                        <option value="1"
                                            {{ $marketing_supervisor->country_id == 1 ? 'selected' : '' }}>India</option>
                                    </select>
                                </div>
