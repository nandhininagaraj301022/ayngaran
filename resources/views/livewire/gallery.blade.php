							...
							<div class="card-body">
								<ul id="lightgallery" class="list-unstyled row">
									...
									<li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0" data-responsive="{{ asset('assets/images/media/3.jpg')}}" data-src="{{ asset('assets/images/media/3.jpg')}}" data-sub-html="<h4>Gallery Image 3</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
										<a href="">
											<img class="img-responsive br-5" src="{{ asset('assets/images/media/3.jpg')}}" alt="Thumb-1">
										</a>
									</li>
									...
									<li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0" data-responsive="{{ asset('assets/images/media/9.jpg')}}" data-src="{{ asset('assets/images/media/9.jpg')}}" data-sub-html="<h4>Gallery Image 9</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
										<a href="">
											<img class="img-responsive mb-0 br-5" src="{{ asset('assets/images/media/9.jpg')}}" alt="Thumb-1">
										</a>
									</li>
									...
									<li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-0 mb-xl-0 border-bottom-0" data-responsive="{{ asset('assets/images/media/12.jpg')}}" data-src="{{ asset('assets/images/media/12.jpg')}}" data-sub-html="<h4>Gallery Image 12</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
										<a href="">
											<img class="img-responsive mb-0 br-5" src="{{ asset('assets/images/media/12.jpg')}}" alt="Thumb-2">
										</a>
									</li>
								</ul>
							</div>
