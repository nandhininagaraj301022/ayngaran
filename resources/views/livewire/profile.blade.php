												...
												<div class="col-lg-12 col-md-12 col-xl-6">
													<div class="wideget-user-desc d-flex">
														<div class="wideget-user-img">
															<img class="" src="{{ asset('assets/images/users/8.jpg')}}" alt="img">
														</div>
														<div class="user-wrap">
															...
															<a href="{{ url('emailservices')}}" class="btn btn-secondary mt-1 mb-1"><i class="fa fa-envelope"></i> E-mail</a>
														</div>
													</div>
												</div>
												<div class="col-lg-12 col-md-12 col-xl-6">
													<div class="text-xl-right mt-4 mt-xl-0">
														<a href="{{ url('emailservices')}}" class="btn btn-white">Message</a>
										...
										<ul class="widget-users row  mb-5">
												...
												<div class="card border p-0">
													<a href="{{ url('profile')}}">
														<div class="card-body text-center">
															<span class="avatar avatar-xxl brround cover-image" data-bs-image-src="{{ asset('assets/images/users/15.jpg')}}"></span>
											...
											<li class="col-lg-4 col-md-6 col-sm-12 col-12">
												<div class="card border p-0">
													<a href="{{ url('profile')}}">
														<div class="card-body text-center">
															<span class="avatar avatar-xxl brround cover-image" data-bs-image-src="{{ asset('assets/images/users/9.jpg')}}"></span>
											...
											<li class="col-lg-4 col-md-6 col-sm-12 col-12">
												<div class="card border p-0">
													<a href="{{ url('profile')}}">
														<div class="card-body text-center">
															<span class="avatar avatar-xxl brround cover-image" data-bs-image-src="{{ asset('assets/images/users/20.jpg')}}"></span>
											...
											<li class="col-lg-4 col-md-6 col-sm-12 col-12">
												<div class="card border p-0 mb-lg-0">
													<a href="{{ url('profile')}}">
														<div class="card-body text-center">
															<span class="avatar avatar-xxl brround cover-image" data-bs-image-src="{{ asset('assets/images/users/12.jpg')}}"></span>
											...
											<li class="col-lg-4 col-md-6 col-sm-12 col-12">
												<div class="card border p-0 mb-lg-0">
													<a href="{{ url('profile')}}">
														<div class="card-body text-center">
															<span class="avatar avatar-xxl brround cover-image" data-bs-image-src="{{ asset('assets/images/users/4.jpg')}}"></span>
											...
											<li class="col-lg-4 col-md-6 col-sm-12 col-12">
												<div class="card border p-0 mb-0">
													<div class="card-body text-center">
														<span class="avatar avatar-xxl brround cover-image" data-bs-image-src="{{ asset('assets/images/users/6.jpg')}}"></span>
														<a href="{{ url('profile')}}"><h4 class="fs-16 mb-0 mt-3 text-dark fw-semibold">Ryan Gossling</h4></a>
														<span class="text-muted">Web designer</span>
													</div>
													<div class="card-footer text-center">
														<div class="row user-social-detail">
									...
									<div class="tab-pane" id="tab-81">
										<div class="row">
											...
											<div class=" col-lg-6 col-md-12">
												<div class="card border p-0 over-flow-hidden">
													<div class="media card-body media-xs overflow-visible ">
														<img class="avatar brround avatar-md me-3" src="{{ asset('assets/images/users/3.jpg')}}" alt="avatar-img">
														<div class="media-body valign-middle mt-0">
