								...
								<div class="card">
									...
									<div class="card-body">
										<div class="example panel panel-default">
											<div class="panel-body p-0">
												<div class="btn-group mt-2 mb-2">
													<button type="button" class="btn btn-facebook btn-pill" data-bs-toggle="dropdown">
														<i class="fa fa-facebook"></i> <span class="caret"></span>
													</button>
												</div>
												<div class="btn-group mt-2 mb-2">
													<button type="button" class="btn btn-twitter btn-pill" data-bs-toggle="dropdown">
														<i class="fa fa-twitter"></i> <span class="caret"></span>
													</button>
												</div>
												<div class="btn-group mt-2 mb-2">
													<button type="button" class="btn btn-google btn-pill" data-bs-toggle="dropdown">
														<i class="fa fa-google"></i> <span class="caret"></span>
													</button>
												</div>
												<div class="btn-group mt-2 mb-2">
													<button type="button" class="btn btn-youtube btn-pill" data-bs-toggle="dropdown">
														<i class="fa fa-youtube "></i><span class="caret"></span>
													</button>
												</div>
												<div class="btn-group mt-2 mb-2">
													<button type="button" class="btn btn-vimeo btn-pill " data-bs-toggle="dropdown">
														<i class="fa fa-vimeo"></i><span class="caret"></span>
													</button>
												</div>
												<div class="btn-group mt-2 mb-2">
													<button type="button" class="btn btn-github btn-pill" data-bs-toggle="dropdown">
