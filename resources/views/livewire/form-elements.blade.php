									...
									<div class="card-body pt-2">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<span class="input-group-text btn btn-primary">Go!</span>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group m-0">
											...
											<div class="row ">
												...
												<div class="col-3">
													<select name="user[day]" class="form-control form-select select2" data-bs-placeholder="Select Day">
											...
											<div class="col-lg-6 col-md-12">
												<form class="form-horizontal">
													...
													<div class=" row mb-4 mb-0">
														...
														<div class="col-md-9">
															<select class="form-control select2" data-bs-placeholder="Choose One">
