									...
									<div class="card-body">
										<div class="productdec text-center">
											<div class="bg-light-gray p-6 text-center br-5">
												<img alt="Product" src="{{ asset('assets/images/pngs/31.png')}}">
											</div>
										</div>
										<div class="text-center mt-5 pb-5 border-bottom">
											<a href="{{ url('cart')}}" class="btn btn-primary"><i class="ti-shopping-cart"> </i> Add to cart</a>
											...
											<div class="panel-body tabs-menu-body">
												<div class="tab-content">
													...
													<div class="tab-pane" id="tab3">
														...
														<div class="media mb-5">
															<div class=" me-3">
																<a href="#"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="{{ asset('assets/images/users/15.jpg')}}"> </a>
															</div>
															<div class="media-body">
										...
										<div id="carouselExampleControls" class="carousel slide  p-2 border" data-bs-ride="carousel">
											<div class="carousel-inner ">
												<div class="carousel-item">
													<img class="pro_img" alt="Product" src="{{ asset('assets/images/pngs/1.png')}}">
													<div class="carouselproduct mt-4 text-center pb-4">
														<h5 class=""><a href="{{ url('shop')}}">Cup</a></h5>
												...
												<div class="carousel-item active">
													<img class="pro_img " alt="Product" src="{{ asset('assets/images/pngs/2.png')}}">
													<div class="carouselproduct mt-4 text-center pb-4">
														<h5 class=""><a href="{{ url('shop')}}">Video Game</a></h5>
														<ul class="product_price list-unstyled">
												...
												<div class="carousel-item">
													<img class="pro_img productborder" alt="Product" src="{{ asset('assets/images/pngs/3.png')}}">
													<div class="carouselproduct mt-4 text-center pb-4">
														<h5 class=""><a href="{{ url('shop')}}">Headset</a></h5>
														<ul class="product_price list-unstyled">
												...
												<div class="carousel-item">
													<img class="pro_img productborder" alt="Product" src="{{ asset('assets/images/pngs/4.png')}}">
													<div class="carouselproduct mt-4 text-center pb-4">
														<h5 class=""><a href="{{ url('shop')}}">Flower pot</a></h5>
														<ul class="product_price list-unstyled">
												...
												<div class="carousel-item">
													<img class="pro_img productborder" alt="Product" src="{{ asset('assets/images/pngs/5.png')}}">
													<div class="carouselproduct mt-4 text-center pb-4">
														<h5 class=""><a href="{{ url('shop')}}">Royal Chair</a></h5>
														<ul class="product_price list-unstyled">
												...
												<div class="carousel-item">
													<img class="pro_img productborder" alt="Product" src="{{ asset('assets/images/pngs/6.png')}}">
													<div class="carouselproduct mt-4 text-center pb-4">
														<h5 class=""><a href="{{ url('shop')}}">Goggles</a></h5>
														<ul class="product_price list-unstyled">
												...
												<div class="carousel-item">
													<img class="pro_img productborder" alt="Product" src="{{ asset('assets/images/pngs/7.png')}}">
													<div class="carouselproduct mt-4 text-center pb-4">
														<h5 class=""><a href="{{ url('shop')}}">Stool</a></h5>
														<ul class="product_price list-unstyled">
												...
												<div class="carousel-item">
													<img class="pro_img productborder" alt="Product" src="{{ asset('assets/images/pngs/8.png')}}">
													<div class="carouselproduct mt-4 text-center pb-4">
														<h5 class=""><a href="{{ url('shop')}}">Headset</a></h5>
														<ul class="product_price list-unstyled">
