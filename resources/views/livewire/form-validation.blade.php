...
@section('content')
						...
						<div class="row">
							...
							<div class="col-lg-12 col-md-12">
								<div class="card">
									<div class="card-header">
										<h3 class="card-title">Supportted Elements</h3>
									</div>
									<div class="card-body">
										<form class="was-validated">
											...
											<div class="mb-3">
												<select class="form-select select2 form-control" required>
											...
											<div class="">
												<div class="input-group is-invalid">
													...
													<select class="form-select form-control" id="validatedInputGroupSelect" required>
														<option value="">Choose...</option>
														<option value="1">One</option>
														<option value="2">Two</option>
														<option value="3">Three</option>
										...
										<form class="needs-validation" novalidate>
											...
											<div class="form-row">
												...
												<div class="col-md-3 mb-3">
													...
													<select class="form-select select2 form-control" id="validationTooltip04" required>
													<option selected disabled value="">Choose...</option>
													<option>...</option>
													</select>
