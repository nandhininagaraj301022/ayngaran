...
@section('content')
						...
						<div class="row">
							<div class="col-xl-3 col-md-12 col-lg-6">
								<div class="card">
									<div class="card-body text-center">
										<h6 class=""><span class="text-primary"><i class="fe fe-file-text me-2 fs-20 text-primary-shadow"></i></span>Total Projects</h6>
							...
							<div class="col-xl-3 col-md-12 col-lg-6">
								<div class="card overflow-hidden">
									<div class="card-body text-center">
										<h6 class=""><span class="text-secondary"><i class="fe fe-users me-2 fs-20 text-secondary-shadow"></i></span>Total Employees</h6>
							...
							<div class="col-xl-3 col-md-12 col-lg-6">
								<div class="card overflow-hidden">
									<div class="card-body text-center">
										<h6 class=""><span class="text-success"><i class="fe fe-award me-2 fs-20 text-success-shadow"></i></span>Ongoing Projects</h6>
							...
							<div class="col-xl-3 col-md-12 col-lg-6">
								<div class="card overflow-hidden">
									<div class="card-body text-center">
										<h6 class=""><span class="text-info"><i class="fe fe-tag me-2 fs-20 text-info-shadow"></i></span>Total Tasks</h6>
								...
								<div class="card">
									<div class="card-body">
										<div class="text-center">
											...
											<p class="mb-0"><span class="dot-label bg-secondary me-2"></span>Num of Employees</p>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
								...
								<div class="card">
									<div class="card-body">
										<div class="widget text-center">
											...
											<p class="mb-0"><span class="dot-label bg-success me-2"></span>Num of Devices</p>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
								...
								<div class="card">
									<div class="card-body">
										<div class="widget text-center">
											...
											<p class="mb-0"><span class="dot-label bg-warning me-2"></span>7 licences about to expire</p>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
								...
								<div class="card">
									<div class="card-body">
										<div class="widget text-center">
											...
											<p class="mb-0"><span class="dot-label bg-danger me-2"></span>Total Running Cost</p>
										</div>
									</div>
								</div>
							</div><!-- COL END -->
						...
						<div class="row">
							<div class="col-sm-12 col-md-12 col-lg-6  col-xl-3">
								<div class="card widgets-cards bg-primary box-primary-shadow">
									<div class="card-body d-flex justify-content-center align-items-center">
										<div class="chart-circle chart-circle-sm ms-5 mt-1" data-value="0.62" data-thickness="6" data-bs-color="#321773"><div class="chart-circle-value text-white">70%</div></div>
							...
							<div class="col-sm-12 col-md-12 col-lg-6  col-xl-3">
								<div class="card widgets-cards bg-success box-success-shadow">
									<div class="card-body d-flex justify-content-center align-items-center">
										<div class="chart-circle chart-circle-sm ms-5 mt-1" data-value="0.37" data-thickness="6" data-bs-color="#0e8c79"><div class="chart-circle-value text-white">17%</div></div>
										<div class="wrp text-wrapper text-white">
											<p class="mt-0">6477</p>
							...
							<div class="col-sm-12 col-md-12 col-lg-6  col-xl-3">
								<div class="card widgets-cards bg-warning box-warning-shadow">
									<div class="card-body d-flex justify-content-center align-items-center">
										<div class="chart-circle chart-circle-sm ms-5 mt-1" data-value="0.42" data-thickness="6" data-bs-color="#c68806"><div class="chart-circle-value text-white">42%</div></div>
										<div class="wrp text-wrapper text-white">
											<p class="mt-0">7847</p>
							...
							<div class="col-sm-12 col-md-12 col-lg-6  col-xl-3">
								<div class="card widgets-cards bg-danger box-danger-shadow">
									<div class="card-body d-flex justify-content-center align-items-center">
										<div class="chart-circle chart-circle-sm ms-5 mt-1" data-value="0.42" data-thickness="6" data-bs-color="#c21a1a"><div class="chart-circle-value text-white">37%</div></div>
										<div class="wrp text-wrapper text-white">
											<p class="mt-0">345</p>
									...
									<div class="row">
										...
										<div class="col-8">
											<div class="card-body p-4">
												<h2 class="mb-2 fw-normal mt-2">17,533</h2>
												<h5 class="fw-normal mb-0">Total Followers</h5>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-sm-12 col-lg-6 col-md-12 col-xl-3">
								<div class="card">
									<div class="row">
										<div class="col-4">
											<div class="circle-icon circle-icon bg-secondary align-items-center text-center box-secondary-shadow">
												<img src="{{ asset('assets/images/svgs/circle.svg')}}" alt="img" class="card-img-absolute">
										...
										<div class="col-8">
											<div class="card-body p-4">
												...
												<h5 class="fw-normal mb-0">Total Likes</h5>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-sm-12 col-lg-6 col-md-12 col-xl-3">
								<div class="card">
									<div class="row">
										<div class="col-4">
											<div class="circle-icon  circle-icon bg-success align-items-center text-center box-success-shadow">
												<img src="{{ asset('assets/images/svgs/circle.svg')}}" alt="img" class="card-img-absolute">
										...
										<div class="col-8">
											<div class="card-body p-4">
												<h2 class="mb-2 fw-normal mt-2">87</h2>
												<h5 class="fw-normal mb-0">Total Comments</h5>
											</div>
										</div>
									</div>
							   </div>
							...
							<div class="col-sm-12 col-lg-6 col-md-12 col-xl-3">
								<div class="card">
									<div class="row">
										<div class="col-4">
											<div class="circle-icon circle-icon bg-danger align-items-center text-center box-danger-shadow">
												<img src="{{ asset('assets/images/svgs/circle.svg')}}" alt="img" class="card-img-absolute">
										...
										<div class="col-8">
											<div class="card-body p-4">
												<h2 class="mb-2 fw-normal mt-2">485</h2>
												<h5 class="fw-normal mb-0">Total Posts</h5>
											</div>
										</div>
									</div>
							   </div>
						...
						<div class="row">
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="clearfix row mb-0">
											...
											<div class="col">
												<div class="float-end">
													<h4 class="fw-bold mt-2 mb-0 text-secondary">55%</h4>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card-body">
										<div class="media mb-5 mt-0">
											<div class="d-flex me-3">
												<a href="#"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="{{ asset('assets/images/users/18.jpg')}}"> </a>
											</div>
										...
										<div class="media mb-5">
											<div class="d-flex me-3">
												<a href="#"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="{{ asset('assets/images/users/4.jpg')}}"> </a>
											</div>
											<div class="media-body">
										...
										<div class="media mb-5">
											<div class="d-flex me-3">
												<a href="#"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="{{ asset('assets/images/users/20.jpg')}}"> </a>
											</div>
											<div class="media-body">
										...
										<div class="media mb-5 mt-0">
											...
											<div class="media-body">
												<a href="#" class="text-dark">Bustos</a>
												<div class="text-muted small">Manager</div>
											</div>
										...
										<div class="media mb-0">
											<div class="d-flex me-3">
												<a href="#"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="{{ asset('assets/images/users/19.jpg')}}"> </a>
											</div>
											<div class="media-body">
							...
							<div class="col-xl-4 col-sm-12 p-l-0 p-r-0 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="mx-auto chart-circle chart-circle-md mt-3 mb-4 text-center" data-value="0.75" data-thickness="8" data-bs-color="#5e2dd8 "></div>
									...
									<div class="card-header">
										...
										<div class="card-body mt-0">
											...
											<div class="chat-details mb-0 p-3">
												<h4 class="mb-0">
													<span class="h5 fw-normal">React js</span>
													<span class="float-end p-1  btn btn-sm text-default">
													<b>46</b>%</span>
												</h4>
												<div class="progress progress-sm mt-3">
													<div class="progress-bar bg-secondary w-45"></div>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card-body p-2">
										<div>
											<div class="row img-gallery" id="lightgallery">
												<div class="col-4" data-responsive="{{ asset('assets/images/media/1.jpg')}}" data-src="{{ asset('assets/images/media/1.jpg')}}">
													<a href="javascript:void(0)" class="d-block link-overlay">
														<img class="d-block img-fluid" src="{{ asset('assets/images/media/1.jpg')}}" alt="">
														<span class="link-overlay-bg">
															<i class="fa fa-search"></i>
														</span>
													</a>
												</div>
												<div class="col-4" data-responsive="{{ asset('assets/images/media/2.jpg')}}" data-src="{{ asset('assets/images/media/2.jpg')}}">
													<a href="javascript:void(0)" class="d-block link-overlay">
														<img class="d-block img-fluid" src="{{ asset('assets/images/media/2.jpg')}}" alt="">
														<span class="link-overlay-bg">
															<i class="fa fa-search"></i>
														</span>
													</a>
												</div>
												<div class="col-4" data-responsive="{{ asset('assets/images/media/3.jpg')}}" data-src="{{ asset('assets/images/media/3.jpg')}}">
													<a href="javascript:void(0)" class="d-block link-overlay">
														<img class="d-block img-fluid" src="{{ asset('assets/images/media/3.jpg')}}" alt="">
														<span class="link-overlay-bg">
															<i class="fa fa-search"></i>
														</span>
													</a>
												</div>
												<div class="col-4" data-responsive="{{ asset('assets/images/media/4.jpg')}}" data-src="{{ asset('assets/images/media/4.jpg')}}">
													<a href="javascript:void(0)" class="d-block link-overlay">
														<img class="d-block img-fluid" src="{{ asset('assets/images/media/4.jpg')}}" alt="">
														<span class="link-overlay-bg">
															<i class="fa fa-search"></i>
														</span>
													</a>
												</div>
												<div class="col-4" data-responsive="{{ asset('assets/images/media/5.jpg')}}" data-src="{{ asset('assets/images/media/5.jpg')}}">
													<a href="javascript:void(0)" class="d-block link-overlay">
														<img class="d-block img-fluid" src="{{ asset('assets/images/media/5.jpg')}}" alt="">
														<span class="link-overlay-bg">
															<i class="fa fa-search"></i>
														</span>
													</a>
												</div>
												<div class="col-4" data-responsive="{{ asset('assets/images/media/6.jpg')}}" data-src="{{ asset('assets/images/media/6.jpg')}}">
													<a href="javascript:void(0)" class="d-block link-overlay">
														<img class="d-block img-fluid" src="{{ asset('assets/images/media/6.jpg')}}" alt="">
														<span class="link-overlay-bg">
															<i class="fa fa-search"></i>
														</span>
													</a>
