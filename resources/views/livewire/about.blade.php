							...
							<div class="col-lg-6">
								<div class="card">
									<div class="card-body about-con pabout">
										<h1 class="mb-4 fw-semibold">Why Zanex ?</h1>
						...
						<div class="row">
							<div class="col-md-6 col-sm-12 col-lg-6 col-xl-3">
								<div class="card text-center overflow-hidden">
									<img src="{{ asset('assets/images/media/1.jpg')}}" alt="img" class="">
									<div class="card-body">
							...
							<div class="col-md-6 col-sm-12 col-lg-6 col-xl-3">
								<div class="card text-center overflow-hidden">
									<img src="{{ asset('assets/images/media/2.jpg')}}" alt="img" class="">
									<div class="card-body">
							...
							<div class="col-md-6 col-sm-12 col-lg-6 col-xl-3">
								<div class="card text-center overflow-hidden">
									<img src="{{ asset('assets/images/media/6.jpg')}}" alt="img" class="">
									<div class="card-body">
							...
							<div class="col-md-6 col-sm-12 col-lg-6 col-xl-3">
								<div class="card text-center overflow-hidden">
									<img src="{{ asset('assets/images/media/7.jpg')}}" alt="img" class="">
									<div class="card-body">
