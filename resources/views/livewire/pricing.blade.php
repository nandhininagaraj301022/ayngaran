...
@section('content')
						...
						<div class="row">
							<div class="col-sm-6 col-xl-3">
								<div class="panel price panel-color plan-card text-center">
									<div class="pt-4">
										<div class="mb-4"><i class="fa fa-rocket plan-icon bg-primary"></i></div>
										<h3 class="text-uppercase fw-semibold text-primary card-category bg-primary-transparent">Starter Pack</h3>
									</div>
							...
							<div class="col-sm-6 col-xl-3">
								<div class="panel price panel-color plan-card text-center">
									<div class="pt-4">
										...
										<h3 class="text-uppercase fw-semibold text-success card-category bg-success-transparent">Professional Pack</h3>
									</div>
									<div class="panel-body text-center">
							...
							<div class="col-sm-6 col-xl-3">
								<div class="panel price panel-color plan-card text-center">
									<div class="pt-4">
										...
										<h3 class="text-uppercase fw-semibold text-orange card-category bg-secondary-transparent">Enterprise Pack</h3>
									</div>
									<div class="panel-body text-center">
									...
									<div class="panel-footer text-center">
										<a class="btn btn-lg btn-secondary" href="#">Sign Up Now</a>
									</div>
								</div>
							</div><!-- COL-END -->
							<div class="col-sm-6 col-xl-3">
								<div class="panel price panel-color plan-card text-center">
									<div class="pt-4">
										<div class="mb-4"><i class="fa fa-cube plan-icon bg-info"></i></div>
										<h3 class="text-uppercase fw-semibold text-info card-category bg-info-transparent">Unlimited Pack</h3>
									</div>
									<div class="panel-body text-center">
									...
									<div class="panel-footer text-center">
										<a class="btn btn-lg btn-info" href="#">Sign Up Now</a>
									</div>
								</div>
							</div><!-- COL-END -->
						</div>
							...
							<div class="col-sm-6 col-xl-3">
								<div class="card">
									<div class="card-body text-center">
										...
										<div class="text-center mt-6">
											<a href="#" class="btn btn-info ">Choose plan</a>
										</div>
									</div>
								</div>
							</div><!-- col-end -->
						...
						<div class="row">
							<div class="col-sm-6 col-xl-3 primary">
								<div class="princing-item mb-4">
									<div class="pricing-divider text-center">
										...
										<h4 class="my-0 display-2 text-light fw-normal mb-3"><span class="h3">$</span> 120 <span class="h5">/mo</span></h4>
							...
							<div class="col-sm-6 col-xl-3 info">
								<div class="princing-item mb-4">
									<div class="pricing-divider text-center">
										...
										<h4 class="my-0 display-2 text-light fw-normal mb-3"><span class="h3">$</span> 150 <span class="h5">/mo</span></h4>
							...
							<div class="col-sm-6 col-xl-3 success">
								<div class="princing-item mb-4">
									<div class="pricing-divider text-center">
										...
										<h4 class="my-0 display-2 text-light fw-normal mb-3"><span class="h3">$</span> 200 <span class="h5">/mo</span></h4>
							...
							<div class="col-sm-6 col-xl-3 secondary">
								<div class="princing-item mb-4">
									<div class="pricing-divider text-center">
										<h3 class="text-light">Enterprise</h3>
										<h4 class="my-0 display-2 text-light fw-normal mb-3"><span class="h3">$</span> 180 <span class="h5">/mo</span></h4>
								...
								<div class="card">
									<div class="card-body text-center pricing bg-primary">
										...
										<div class="text-center mt-4">
											<a href="#" class="btn btn-white d-grid">Buy Now</a>
										</div>
									</div>
								</div>
							</div><!-- COL-END -->
