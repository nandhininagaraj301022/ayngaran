							...
							<div class="col-xl-4 col-md-12">
								<div class="card cart">
									...
									<div class="card-body">
										<div class="d-md-flex">
											<div class="d-flex">
												<img class="img-fluid avatar-lg border p-0 br-7" src="{{ asset('assets/images/pngs/9.png')}}" alt="img">
												<div class="ms-3 mt-2">
													<h4 class="mb-1 fw-semibold fs-14"><a href="#">bracelets</a></h4>
										...
										<div class="d-md-flex mt-5">
											<div class="d-flex">
												<img class="img-fluid avatar-lg border p-0 br-7" src="{{ asset('assets/images/pngs/1.png')}}" alt="img">
												<div class="ms-3 mt-2">
													<h4 class="mb-1 fw-semibold fs-14"><a href="#">Cup</a></h4>
													<div class="mb-2 text-warning fs-14">
														<i class="fa fa-star"></i>
														<i class="fa fa-star"></i>
														<i class="fa fa-star"></i>
										...
										<div class="d-md-flex mt-5">
											<div class="d-flex">
												<img class="img-fluid avatar-lg border p-0 br-7" src="{{ asset('assets/images/pngs/6.png')}}" alt="img">
												<div class="ms-3 mt-2">
													<h4 class="mb-1 fw-semibold fs-14"><a href="#">Goggles</a></h4>
													<div class="mb-2 text-warning fs-14">
														<i class="fa fa-star"></i>
														<i class="fa fa-star"></i>
														<i class="fa fa-star"></i>
