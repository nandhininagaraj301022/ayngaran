										...
										<div class="card item-card">
											...
											<div class="product-grid6  card-body">
												...
												<div class="product-content text-center">
													...
													<h4 class="title"><a href="#">bracelets</a></h4>
													<div class="price">$16,599<span class="ms-4">$19,799</span></div>
												</div>
												<ul class="icons">
													<li><a href="{{ url('shop-description')}}" data-tip="Quick View"><i class="fe fe-eye "></i></a></li>
													<li><a href="{{ url('wishlist')}}" data-tip="Add to Wishlist"><i class="fa fa-heart-o"></i></a></li>
													<li><a href="{{ url('cart')}}" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
												</ul>
											</div>
										</div>
									</div>
										...
										<div class="card item-card">
											...
											<div class="product-grid6 card-body">
												...
												<div class="product-content text-center">
													...
													<h4 class="title"><a href="#">Cup</a></h4>
									...
									<div class="col-md-6 col-xl-4">
										<div class="card item-card">
											<div class="product-grid6  card-body">
												<div class="product-image6">
													<a href="{{ url('shop-description')}}">
														<img class="img-fluid" src="{{ asset('assets/images/pngs/7.png')}}" alt="img">
													</a>
												</div>
												<div class="product-content text-center">
													<div class="text-center mb-2 text-warning">
													...
													<h4 class="title"><a href="#">Stool</a></h4>
										...
										<div class="card item-card">
											...
											<div class="product-grid6  card-body">
												...
												<div class="product-content text-center">
													...
													<h4 class="title"><a href="#">Video Game</a></h4>
										...
										<div class="card item-card">
											<div class="product-grid6  card-body">
												...
												<div class="product-content text-center">
													...
													<h4 class="title"><a href="#">Watch</a></h4>
										...
										<div class="card item-card">
											<div class="product-grid6  card-body">
												...
												<div class="product-content text-center">
													...
													<h4 class="title"><a href="#">Headset</a></h4>
										...
										<div class="card item-card">
											...
											<div class="product-grid6  card-body">
												...
												<div class="product-content text-center">
													...
													<h4 class="title"><a href="#">Goggles</a></h4>
