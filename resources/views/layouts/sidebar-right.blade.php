					...
					<div class="panel-body tabs-menu-body latest-tasks p-0 border-0">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="side1">
								...
								<a class="dropdown-item d-flex border-bottom" href="{{url('chat')}}">
								...
								<a class="dropdown-item d-flex border-bottom" href="{{url('emailservices')}}">
								...
								<a class="dropdown-item d-flex border-bottom" href="{{url('editprofile')}}">
								...
								<a class="dropdown-item d-flex border-bottom" href="{{url('login')}}">
